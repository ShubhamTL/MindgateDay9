...
public class TestSpring {
	...
	public static void main(String[] args) {
		ApplicationContext beanFactory = new ClassPathXmlApplicationContext("springhello.xml");
		...
		annoservice.proccessApplication();
		annoservice.proccessApplicationWithAudit();
	}
}
